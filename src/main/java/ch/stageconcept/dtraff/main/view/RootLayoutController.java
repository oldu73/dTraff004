...
public class RootLayoutController {
    ...
    @FXML
    private MenuItem lockPasswordMenuItem;
    ...
    /**
     * Called when the user selects the tool bar File - Password - Lock menu.
     */
    @FXML
    private void handleLockPassword() {
        connRoot.lockPassword(getSelectedConnFile());
    }
